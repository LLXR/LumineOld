...
import Lumine.modules.sql.welcome_sql as sql
import Lumine
from Lumine import (
    DEV_USERS,
    LOGGER,
...
from Lumine.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from Lumine.modules.helper_funcs.msg_types import get_welcome_type
from Lumine.modules.helper_funcs.string_handling import (
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not Lumine.ALLOW_CHATS:
